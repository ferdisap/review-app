export const search = {
  ...
  open(e = null) {
    ...
    this.modal.addEventListener('keyup', this.keyupHandler.bind(this));
    ...
    this.isOpen = true;
    document.querySelector('#modal').setAttribute('active', this.modalContainerId);
  },
  removeEvent(){
  ...
  init() {
    document.addEventListener('keydown', (e) => {
      switch (e.key) {
        case "/":
          if (this.modal.parentElement.getAttribute('active') == 'none') {
            this.open(e);
